...
Shell commands used to deploy smart contract (modify deployment script from this repo as appropriate):
...
Shell command used to upgrade smart contract (modify upgrade script from this repo as appropriate):
